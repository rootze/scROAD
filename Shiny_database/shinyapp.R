  ...
  tabsetPanel(
    tabPanel("Home",
             fluidPage(
               ...
               fluidRow(
                 column(4, img(src = "https://raw.githubusercontent.com/rootze/scROAD/main/images/swaruplab.png", height = "100px", style="display: block; margin-left: auto; margin-right: auto;")),
               ...
               h3("How to Cite"),
               p(HTML(
                 'Shi Z, Das S, Morabito S, Stocksdale J, Miyoshi E, Emerson N, Srinivasan SS, Shahin A, Rahimzadeh N, Cao Z, Silva J, Castaneda AA, Head E, Thompson L, Swarup V. Single-nucleus multi-omics identifies shared and distinct pathways in Pick&#39;s and Alzheimer&#39;s disease. Sci. Adv. 11, eads7973 (2025). DOI: <a href="https://www.science.org/doi/10.1126/sciadv.ads7973" target="_blank">10.1126/sciadv.ads7973</a>'
               )),            
               hr(),
               h3("Complete Code for the Science Advances Project"),
               p(HTML('Please check out the complete analysis & code for this project at <a href="https://github.com/swaruplabUCI/scMultiomics_identifies_shared_and_distinct_pathways_in_PiDandAD" target="_blank">GitHub: scMultiomics_identifies_shared_and_distinct_pathways_in_PiDandAD</a>.')),
               hr(),
    ...
    tabPanel("Introductory Vignettes",
        ...
        ")),
               ...
               tags$ul(
                 ...
                 tags$li("log2FC_TFBS: log2 fold-changes estimated from TOBIAS activity scores on the target peak, calculated by comparing Disease and Control")
               ),
               hr(),
    ...
    tabPanel("TF Occupancy Data Explorer",
             sidebarLayout(
               sidebarPanel(
                 ...
                 tags$p(
                   style = "color: red;",
                   "Note for researchers: Because the TF binding prediction data on cis-regulatory OCRs is very large, please use target selection, chromosome position search, or both to narrow your query."
                 ),
                 ...
                 tags$div(style = "background-color: #d2c1e2; padding: 10px; border-radius: 5px; margin-top: 20px;",
                          ...
                          This base position search can be used to query SNP or nucleotide positions. For example, for rs9272480 (chr6:32638023, GRCh38), you can enter the base position <b>32638023</b>; there is no need to specify <b>chr6</b> because the chromosome is selected above. 
                          You can find SNP positions using <a href="https://www.ncbi.nlm.nih.gov/snp/" target="_blank">dbSNP (NCBI)</a>. 
                          Please note that all analyses were performed using the Genome Reference Consortium Human Build 38 (GRCh38), so make sure you use human genome positions in this reference build.
                          </span>
                          ')),
    ...
    tabPanel("Blog: TF Footprinting on Disease",
             fluidPage(
               h3("Unveiling TF Footprinting: A New Frontier in Regulatory Network Analysis for Neurodegenerative Disease"),
               hr(),
               h4("Introduction"),
               ...
               hr(),
               h4("A Functional TF Footprinting Approach for Disease-Related Regulatory Networks"),
               ...
               hr(),
               h4("Conclusion"),
               p("This functional TF footprinting approach represents a major step forward in regulatory network analysis, addressing the limitations of conventional methods like SCENIC and SCENIC+. By leveraging tools like TOBIAS to measure TF occupancy directly, we can distinguish functional regulatory events from non-functional motifs, providing deeper insights into gene regulation in neurodegenerative diseases. As we continue to refine these methods, they will undoubtedly play a critical role in shaping the future of genomic research and therapeutic discovery."),
               hr(),
               h4("References"),
               tags$ol(
                 tags$li("S. Aibar, C. B. González-Blas, T. Moerman, V. A. Huynh-Thu, H. Imrichova, G. Hulselmans, F. Rambow, J. C. Marine, P. Geurts, J. Aerts, et al., SCENIC: single-cell regulatory network inference and clustering. Nat. Methods 14, 1083–1086 (2017). DOI: ",
                         tags$a(href = "https://doi.org/10.1038/nmeth.4463", "10.1038/nmeth.4463", target = "_blank")),
                 tags$li("C. Bravo González-Blas, S. De Winter, G. Hulselmans, N. Hecker, I. Matetovici, V. Christiaens, S. Poovathingal, J. Wouters, S. Aibar, S. Aerts, SCENIC+: single-cell multiomic inference of enhancers and gene regulatory networks. Nat. Methods 20, 1355–1367 (2023). DOI: ",
                         tags$a(href = "https://doi.org/10.1038/s41592-023-01938-4", "10.1038/s41592-023-01938-4", target = "_blank")),
                 tags$li("H. Mathys, C. A. Boix, L. A. Akay, Z. Xia, J. Davila-Velderrain, A. P. Ng, X. Jiang, G. Abdelhady, K. Galani, J. Mantero, N. Band, B. T. James, S. Babu, F. Galiana-Melendez, K. Louderback, D. Prokopenko, R. E. Tanzi, D. A. Bennett, L. H. Tsai, M. Kellis, Single-cell multiregion dissection of Alzheimer's disease. Nature 632, 858–868 (2024). DOI: ",
                         tags$a(href = "https://doi.org/10.1038/s41586-024-07606-7", "10.1038/s41586-024-07606-7", target = "_blank")),
                 tags$li("X. Xiong, B. T. James, C. A. Boix, Y. P. Park, K. Galani, M. B. Victor, N. Sun, L. Hou, L. L. Ho, J. Mantero, A. N. Scannail, V. Dileep, W. Dong, H. Mathys, D. A. Bennett, L. H. Tsai, M. Kellis, Epigenomic dissection of Alzheimer's disease pinpoints causal variants and reveals epigenome erosion. Cell 186, 4422–4437.e21 (2023). DOI: ",
                         tags$a(href = "https://doi.org/10.1016/j.cell.2023.08.040", "10.1016/j.cell.2023.08.040", target = "_blank")),
                 tags$li("B. Frost, M. Hemberg, J. Lewis, M. B. Feany, Tau promotes neurodegeneration through global chromatin relaxation. Nat. Neurosci. 17, 357–366 (2014). DOI: ",
                         tags$a(href = "https://doi.org/10.1038/nn.3639", "10.1038/nn.3639", target = "_blank")),
                 tags$li("S. Baek, I. Goldstein, G. L. Hager, Bivariate genomic footprinting detects changes in transcription factor activity. Cell Rep. 19, 1710–1722 (2017). DOI: ",
